class Help
    ...
    listen_to :connect, method: :setup
        ...
        set :help, <<-EOF
[\x0307Help\x03] #{Helpers.get_config.key?("prefix") ? Config.config["prefix"] : "!"}help - Lists plugins that support help.        
[\x0307Help\x03] #{Helpers.get_config.key?("prefix") ? Config.config["prefix"] : "!"}help <plugin> - Gets help for <plugin>.
        EOF
